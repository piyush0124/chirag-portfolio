...
<head>
    ...
    <link rel="icon" href="assets/img/Chirag Hasija logo_50x50.svg">
    ...
    <title>Chiraj Hasija | Portfolio</title>
    ...
    <div class="ts-page-wrapper" id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white">
            <div class="container">
                <a class="navbar-brand ts-push-down__50 position-absolute ts-bottom__0  pb-0 ts-z-index__1 ts-scroll" href="#page-top">
                    <img src="assets/img/Chirag Hasija logo.svg" alt="">
                </a>
                <!--end navbar-brand-->
        ...
        <div id="ts-hero" class="ts-animate-hero-items">
                ...
                <div class="row w-100">
                    <div class="col-md-8">
                        ...
                        <figure class="ts-social-icons mb-4">
                            <a href="https://www.facebook.com/profile.php?viewas=100000686899395&id=100007822547085" target="_blank" class="mr-3">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a href="https://twitter.com/chirag_hasija98" target="_blank" class="mr-3">
                                <i class="bi bi-twitter-x"></i>
                            </a>
                            <a href="https://www.linkedin.com/in/chiragapac/" target="_blank" class="mr-3">
                                <i class="bi bi-linkedin"></i>
                            </a>
                            
                            <a href="https://www.instagram.com/itz_chirag_hasija/" target="_blank" class="mr-3">
                                <i class="bi bi-instagram"></i>
                            </a>
                        </figure>

                        <!--TITLE -->
                        <h1>I am Chirag Hasija</h1>
                        <h1 class="ts-bubble-border">
                            <span class="ts-title-rotate">
                            <span class="active">Video Editor</span>
            ...
            <div class="ts-background">
                <div class="ts-background-image" data-bg-image="assets/img/Chirag-Hasija-B.png"></div>
            </div>
            <!--END HERO BACKGROUND *********************************************************************************-->
        ...
        <main id="ts-content">
            ...
            <section id="about-me" class="ts-block pb-4">
                <div class="container">
                    ...
                    <div class="row ts-align__vertical">
                        <div class="col-md-6">
                            <img src="assets/img/for-Id-Card_.png" alt="" class="mw-100 mb-5">
                        </div>
                        <div class="col-md-6">
                            <h4 class="ts-bubble-border">Hi There</h4>
                            <p>
                           Welcome to our creative hub! <br> I'm Chirag Hasija, an experienced professional in the field of video editing and graphic design. With a passion for visual storytelling, I bring ideas to life through captivating visuals and seamless editing. Whether it's crafting compelling narratives or enhancing brand identities, I thrive on delivering exceptional results. With a keen eye for detail and a dedication to quality, I aim to exceed expectations and leave a lasting impact. Join me on this journey of creativity and innovation, where imagination knows no bounds.                            </p>
                            <dl class="ts-column-count-2">
                                ...
                                <dd>8791104567</dd>
                                <dt>Email:</dt>
                                <dd>chiraghasija54@gmail.com</dd>
                                <dt>Linkedin</dt>
                                <dd>www.linkedin.com/in/chiragapac/</dd>
                            </dl>
                            <hr class="ts-hr-light mb-5">
                            <a href="https://apacnewsnetwork.com/chirag-port/assets/img/Chirag-Hasija-CV.pdf" target="_blank" class="ts-btn-effect mr-2">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                Phasellus accumsan scelerisque dolor, quis mattis justo bibendum non. Nulla sollicitudin turpis in enim elementum varius. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae
                            </p>
                        ...
                        <div class="col-md-6">
                            <div class="progress" data-progress-width="90%">
                                <h5 class="ts-progress-title">Video Editing</h5>
                            ...
                            <!--end progress-->
                            <div class="progress" data-progress-width="90%">
                                <h5 class="ts-progress-title">Graphic Desigining</h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
                            <div class="progress" data-progress-width="80%">
                                <h5 class="ts-progress-title">Event Management </h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
            ...
            <section class="ts-block" data-bg-image="assets/img/bg-man-sitting.png">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <p>
                                            In id nulla magna. Nullam posuere fermentum mattis. Nunc id dui at sapien faucibus fermentum ut vel diam. Nullam tempus, nunc id efficitur sagittis, urna est ultricies.
                                        </p>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <p>
                                            Phasellus volutpat velit nec purus elementum feugiat. Nunc feugiat fringilla turpis. Nam sed facilisis sem. Vestibulum vitae orci nec purus fringilla condimentum. Pellentesque id augue rhoncus, finibus sapien ut, commodo eros. Maecenas in nibh augue.
                                            Nunc rutrum blandit massa eu aliquet. Nulla facilisi. Aenean luctus ipsum in orci sagittis auctor vel sit amet ex
                                        </p>
                                        <a href="#" class="mb-4 text-dark d-block">
                                            <i class="fa fa-globe ts-opacity__50 mr-2"></i>
                                            www.example.com
